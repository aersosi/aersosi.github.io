      ...
      1: [
        function (e, n, t) {
          ...
          var u = function (e) {
            ...
            c = function (e) {
              return (
                null != (e = e || document.querySelector(".Lightbox")) &&
          ...
          t.create = function (e, o) {
            ...
            var r = (function (e, n) {
                var t = u(
                    '\n\t\t<div class="Lightbox '.concat(
                      n.className,
                      '">\n\t\t\t<div class="Lightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t'
                    )
                  ),
                  o = t.querySelector(".Lightbox__placeholder");
                e.forEach(function (e) {
                  var imgUrl = e.src
                  e.style.backgroundImage = "url('"+imgUrl+"')"
                  e.src = './dist/img/flg_t.png';
                ...
                var r = a(o, "IMG"),
                  ...
                  c = a(o, "IFRAME");
                return (
                  !0 === r && t.classList.add("Lightbox--img"),
                  !0 === i && t.classList.add("Lightbox--video"),
                  !0 === c && t.classList.add("Lightbox--iframe"),
                  t
                );
              })(
                (e = (function (e) {
              ...
              n = function (e) {
                return (
                  ...
                  (n = r).classList.remove("Lightbox--visible"),
                  setTimeout(function () {
                ...
                return (
                  ...
                  setTimeout(function () {
                    requestAnimationFrame(function () {
                      ...
                      return n.classList.add("Lightbox--visible"), t();
                    });
                  }, 10),
                  !0)
                );
