...
"use strict";function asyncGeneratorStep(e,t,n,o,r,i,c){try{var u=e[i](c),a=u.value}catch(e){return void n(e)}u.done?t(a):Promise.resolve(a).then(o,r)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(o,r){var i=e.apply(t,n);function c(e){asyncGeneratorStep(i,o,r,c,u,"next",e)}function u(e){asyncGeneratorStep(i,o,r,c,u,"throw",e)}c(void 0)})}}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}document.addEventListener("DOMContentLoaded",function(e){var t=function(e,t){var n=URL.createObjectURL(e),o='<div class="img-cont flg_'.concat(t,'">\n                  <img class="image" src="').concat(n,'" alt="Flag number ').concat(t,'">\n                </div>');l.innerHTML+=o};function n(){document.querySelectorAll(".img-cont img").forEach(function(e){e.addEventListener("click",function(e){var t=e.target.src;Lightbox.create('<img src="'.concat(t,'">')).show()})})}function o(){setTimeout(function(){document.querySelectorAll(".img-cont:not(.show)").forEach(function(e,t){setTimeout(function(){e.classList.add("show")},100*t)})},100)}window.requestAnimationFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},function(e){"object"==("undefined"==typeof exports?"undefined":_typeof(exports))&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).Lightbox=e()}(function(){return function e(t,n,o){function r(c,u){if(!n[c]){if(!t[c]){var a="function"==typeof require&&require;if(!u&&a)return a(c,!0);if(i)return i(c,!0);var s=new Error("Cannot find module '"+c+"'");throw s.code="MODULE_NOT_FOUND",s}var l=n[c]={exports:{}};t[c][0].call(l.exports,function(e){return r(t[c][1][e]||e)},l,l.exports,e,t,n,o)}return n[c].exports}for(var i="function"==typeof require&&require,c=0;c<o.length;c++)r(o[c]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var o=function(e){var t=1<arguments.length&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},i=function(e){return null!=(e=e||document.querySelector(".Lightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=i,n.create=function(e,t){var n=function(e,t){var n=o('\n\t\t<div class="Lightbox '.concat(t.className,'">\n\t\t\t<div class="Lightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),i=n.querySelector(".Lightbox__placeholder");e.forEach(function(e){return i.appendChild(e)});var c=r(i,"IMG"),u=r(i,"VIDEO"),a=r(i,"IFRAME");return!0===c&&n.classList.add("Lightbox--img"),!0===u&&n.classList.add("Lightbox--video"),!0===a&&n.classList.add("Lightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(o(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),c=function(e){return!1!==t.onClose(u)&&(r=function(){if("function"==typeof e)return e(u)},(o=n).classList.remove("Lightbox--visible"),setTimeout(function(){return!1===i(o)||o.parentElement.removeChild(o),r()},250),!0);var o,r};!0===t.closable&&n.addEventListener("click",function(e){e.target===n&&c()});var u={element:function(){return n},visible:function(){return i(n)},show:function(e){return!1!==t.onShow(u)&&(o=n,r=function(){if("function"==typeof e)return e(u)},document.body.appendChild(o),setTimeout(function(){requestAnimationFrame(function(){return o.classList.add("Lightbox--visible"),r()})},10),!0);var o,r},close:c};return u}},{}]},{},[1])(1)});var r,i,c,u,a,s=document.querySelector("#content_wrapper"),l=document.querySelector("#content section"),f=13,d=!0;function m(){var e=document.querySelector(".slider"),t=document.querySelector("section").scrollWidth;e.style.clip="rect(0px,"+t+"px,200px,0px)"}m(),r=document.querySelectorAll(".slideItem")[0],i=0,setInterval(function(){i++,r.style.marginLeft=-i+"px",515==i&&(r.style.marginLeft="0px",i=0)},10),o(),n(),document.querySelector(".toTopButton").addEventListener("click",function(){s.scrollTo({top:0,left:0,behavior:"smooth"})},!1),s.addEventListener("scroll",(c=function(){s.scrollTop+s.offsetHeight+300>l.offsetHeight&&d&&_asyncToGenerator(regeneratorRuntime.mark(function e(){var r,i,c,u;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,fetch("./dist/img/flags/flg_".concat(f,".jpg"));case 2:return r=e.sent,e.next=5,r.blob();case 5:return i=e.sent,e.next=8,fetch("./dist/img/flags/flg_".concat(f,".png"));case 8:return c=e.sent,e.next=11,c.blob();case 11:u=e.sent,r.ok?(t(i,f),f+=1,n(),o()):c.ok?(t(u,f),f+=1,n(),o()):(d=!1,console.info("Out of Flags"));case 13:case"end":return e.stop()}},e)}))()},u=30,a=Date.now(),function(){a+u-Date.now()<0&&(c(),a=Date.now())}),!1),window.addEventListener("resize",m)});
//# sourceMappingURL=data:application/json;charset=utf8;base64,
