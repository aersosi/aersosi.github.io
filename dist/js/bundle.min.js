...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}document.addEventListener("DOMContentLoaded",function(e){function n(){document.querySelectorAll(".img-cont:not(.show)").forEach(function(e,n){setTimeout(function(){e.classList.add("show")},100*n)})}window.requestAnimationFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},function(e){"object"==("undefined"==typeof exports?"undefined":_typeof(exports))&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).Lightbox=e()}(function(){return function e(n,t,o){function r(c,a){if(!t[c]){if(!n[c]){var l="function"==typeof require&&require;if(!a&&l)return l(c,!0);if(i)return i(c,!0);var u=new Error("Cannot find module '"+c+"'");throw u.code="MODULE_NOT_FOUND",u}var s=t[c]={exports:{}};n[c][0].call(s.exports,function(e){return r(n[c][1][e]||e)},s,s.exports,e,n,t,o)}return t[c].exports}for(var i="function"==typeof require&&require,c=0;c<o.length;c++)r(o[c]);return r}({1:[function(e,n,t){Object.defineProperty(t,"__esModule",{value:!0}),t.create=t.visible=void 0;var o=function(e){var n=1<arguments.length&&void 0!==arguments[1]&&arguments[1],t=document.createElement("div");return t.innerHTML=e.trim(),!0===n?t.children:t.firstChild},r=function(e,n){var t=e.children;return 1===t.length&&t[0].tagName===n},i=function(e){return null!=(e=e||document.querySelector(".Lightbox"))&&!0===e.ownerDocument.body.contains(e)};t.visible=i,t.create=function(e,n){var t=function(e,n){var t=o('\n\t\t<div class="Lightbox '.concat(n.className,'">\n\t\t\t<div class="Lightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),i=t.querySelector(".Lightbox__placeholder");e.forEach(function(e){return i.appendChild(e)});var c=r(i,"IMG"),a=r(i,"VIDEO"),l=r(i,"IFRAME");return!0===c&&t.classList.add("Lightbox--img"),!0===a&&t.classList.add("Lightbox--video"),!0===l&&t.classList.add("Lightbox--iframe"),t}(e=function(e){var n="string"==typeof e,t=e instanceof HTMLElement==1;if(!1===n&&!1===t)throw new Error("Content must be a DOM element/node or string");return!0===n?Array.from(o(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),n=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(n)),c=function(e){return!1!==n.onClose(a)&&(r=function(){if("function"==typeof e)return e(a)},(o=t).classList.remove("Lightbox--visible"),setTimeout(function(){return!1===i(o)||o.parentElement.removeChild(o),r()},410),!0);var o,r};!0===n.closable&&t.addEventListener("click",function(e){e.target===t&&c()});var a={element:function(){return t},visible:function(){return i(t)},show:function(e){return!1!==n.onShow(a)&&(o=t,r=function(){if("function"==typeof e)return e(a)},document.body.appendChild(o),setTimeout(function(){requestAnimationFrame(function(){return o.classList.add("Lightbox--visible"),r()})},10),!0);var o,r},close:c};return a}},{}]},{},[1])(1)});var t,o,r,i,c,a=document.querySelector("#content_wrapper"),l=document.querySelector("#content section"),u=13,s=u+1,f=u+2;function d(){document.querySelectorAll(".img-cont img").forEach(function(e){e.addEventListener("click",function(e){var n=e.target.src;Lightbox.create('<img src="'.concat(n,'">')).show()})})}d(),t=document.querySelectorAll(".slideItem")[0],o=0,setInterval(function(){o++,t.style.marginLeft=-o+"px",515==o&&(t.style.marginLeft="0px",o=0)},10),n(),document.querySelector(".toTopButton").addEventListener("click",function(){a.scrollTo({top:0,left:0,behavior:"smooth"})},!1),a.addEventListener("scroll",(r=function(){if(a.scrollTop+a.offsetHeight+200>l.offsetHeight&&u<35){var e='\n        <div class="img-cont flg_'.concat(u,'">\n          <img class="image" src="./dist/img/flags/flg_').concat(u,'.jpg" alt="Flag number ').concat(u,'">\n        </div>\n        <div class="img-cont flg_').concat(s,'">\n          <img class="image" src="./dist/img/flags/flg_').concat(s,'.jpg" alt="Flag number ').concat(s,'">\n        </div>\n        <div class="img-cont flg_').concat(f,'">\n          <img class="image" src="./dist/img/flags/flg_').concat(f,'.jpg" alt="Flag number ').concat(f,'">\n        </div>');l.innerHTML+=e,n(),d(),u+=3,s+=3,f+=3}},i=30,c=Date.now(),function(){c+i-Date.now()<0&&(r(),c=Date.now())}),!1)});
//# sourceMappingURL=data:application/json;charset=utf8;base64,
